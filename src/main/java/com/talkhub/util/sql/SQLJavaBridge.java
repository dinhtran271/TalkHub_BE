...
public class SQLJavaBridge {
    ...
    private static void addToJson(JsonObject json, String label, Object value) {
        if(value == null){
            json.add(label, null);
            return;
        }
    ...
    private static boolean addAsJson(JsonObject json, String label, String value) {
    ...
    private static  void addParamsByValue(PreparedStatement st, int index, Object value, Type type) throws SQLException {
    ...
    private static  void addParamsByField(PreparedStatement st, int index, JsonElement value) throws IllegalAccessException, SQLException {
        if(value.isJsonNull()){
